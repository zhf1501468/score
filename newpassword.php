...
<br/>
                                     <div class="form-group input-group">
                                            ...
                                            <input type="text" name='oldpassword' class="form-control" placeholder="原密码" />
                                        </div>
                                      <div class="form-group input-group">
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-lock"  ></i></span>
                                            <input type='text' name='password1' class="form-control"  placeholder="确认新密码" />
                                        </div>
...
<body>
	<form action='newpassworddo.php' method='post'>
		原密码：<input type='password' name='oldpassword' /> 新密码： <input
			type='password' name='password' /> 再输新密码： <input type='password'
			name='password1' /> <input type='submit' value='确认修改' />
	</form>
</body>
</html>*/
?>